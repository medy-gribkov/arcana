...
export function scoreSkill(
  ...
  // Determine verdict
  let verdict: RecommendVerdict["verdict"];
  if (score >= 40) verdict = "recommended";
  else if (score >= 15) verdict = "optional";
  else verdict = "skip";

  return { skill: skill.name, verdict, score, reasons };
}

export function rankSkills(skills: SkillInfo[], context: ProjectContext): RecommendVerdict[] {
