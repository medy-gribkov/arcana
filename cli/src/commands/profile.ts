...
function writeProfiles(profiles: Record<string, string[]>): void {
...
function listProfiles(json?: boolean): void {
...
function createProfile(name: string | undefined, skills: string[], json?: boolean): void {
  if (!name) {
    if (json) {
...
function deleteProfile(name: string | undefined, json?: boolean): void {
  if (!name) {
    if (json) {
      console.log(JSON.stringify({ error: "Profile name is required" }));
    } else {
...
function showProfile(name: string | undefined, json?: boolean): void {
  if (!name) {
    if (json) {
      console.log(JSON.stringify({ error: "Profile name is required" }));
    } else {
...
async function applyProfile(name: string | undefined, json?: boolean): Promise<void> {
  if (!name) {
    if (json) {
      console.log(JSON.stringify({ error: "Profile name is required" }));
    } else {
